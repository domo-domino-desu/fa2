...
data class TranslationRequest(
    ...
    init {
        ...
        require(sourceLanguageCode.isNotBlank()) { "Translation source language code must not be blank." }
        require(targetLanguageCode.isNotBlank()) { "Translation target language code must not be blank." }
