...
class WatchlistStore(
     ...
     */
    suspend fun invalidateUserCategory(
        username: String,
        category: WatchlistCategory,
    ) {
    ...
    private fun buildStore(): Store<WatchlistPageKey, WatchlistPage> {
        val fetcher = Fetcher.of<WatchlistPageKey, WatchlistPage>(name = "watchlist-fetcher") { key ->
        ...
        val sourceOfTruth = SourceOfTruth.of<WatchlistPageKey, WatchlistPage, WatchlistPage>(
            reader = { key ->
...
private fun Flow<PageState<WatchlistPage>?>.flowWithInitialLoading(): Flow<PageState<WatchlistPage>> = flow {
