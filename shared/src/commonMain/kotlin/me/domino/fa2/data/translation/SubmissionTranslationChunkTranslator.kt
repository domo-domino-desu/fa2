        ...
        runCatching {
            ...
            .fold(
                ...
                onFailure = { error ->
                  ...
                  return List(chunk.sourceTexts.size) { TextTranslationResult.Failure(error) }
                },
            )
    ...
    return translatedLines
        .map { translatedLine ->
          ...
          if (cleanedTranslation.isBlank()) {
            TextTranslationResult.Empty
          } else {
            TextTranslationResult.Success(cleanedTranslation)
          }
        }
        .also {
