...
class UserChildRouteScreen(
    ...
    override val key: String = "user-child:${username.lowercase()}:${route.routeKey}:${initialFolderUrl.orEmpty()}"
        ...
        when (route) {
            UserChildRoute.Journals -> {
                ...
                key(scrollKey) {
                    ...
                    var deferredBodyScrollPosition by remember(scrollKey) {
                    ...
                    UserJournalsScreen(
                        ...
                        onDeferredBodyScrollPositionConsumed = {
                            deferredBodyScrollPosition = null
                        },
                ...
                val scrollKey = remember(username, route, routeInitialFolderUrl) {
                ...
                val initialSnapshot = remember(scrollKey) {
                    resolveSubmissionSnapshot(scrollKey)
                }
                val screenModel = koinScreenModel<UserSubmissionSectionScreenModel> {
                    parametersOf(
                        username,
                        route,
                        submissionListHolder,
