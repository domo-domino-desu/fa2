...
import me.domino.fa2.ui.component.topbar.JournalDetailRouteTopBar
...
class JournalDetailRouteScreen(
    ...
    override fun Content() {
        ...
        val screenModel = koinScreenModel<JournalDetailScreenModel> {
            parametersOf(journalId, journalUrl)
        }
        val state by screenModel.state.collectAsState()
        val shareUrl = when (val snapshot = state) {
...
private fun JournalCommentItem(
    ...
    Column(
        ...
        val authorClickableModifier = if (normalizedAuthor.isNotBlank()) {
