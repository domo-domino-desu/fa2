...
import me.domino.fa2.ui.component.platform.PlatformVerticalScrollbar
...
fun SubmissionPager(
    ...
    LaunchedEffect(safeInitialIndex, submissions.size) {
        if (pagerState.currentPage != safeInitialIndex && safeInitialIndex in 0 until pagerState.pageCount) {
