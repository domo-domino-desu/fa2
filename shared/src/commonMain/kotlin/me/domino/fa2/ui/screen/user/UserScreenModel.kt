...
class UserScreenModel(
    ...
    UserUiState(
        username = username,
        loading = true,
        submissionRouteFolderUrls = buildInitialFolderUrls(
    ...
    private val submissionSectionSnapshots: MutableMap<String, UserSubmissionSectionUiState> = mutableMapOf()
    ...
    fun toggleProfileExpanded() {
        mutableState.value = state.value.copy(
            profileExpanded = !state.value.profileExpanded,
        )
    }
     ...
     * 更新某子路由当前 folder URL。
     */
    fun setSubmissionRouteFolderUrl(
    ...
    internal fun setSharedTopScrollState(
        position: UserSharedTopScrollState,
    ) {
    ...
    internal fun setBodyScrollPosition(
        scrollKey: String,
        position: UserBodyScrollPosition,
    ) {
    ...
    fun setSubmissionSectionSnapshot(
        cacheKey: String,
        snapshot: UserSubmissionSectionUiState,
    ) {
