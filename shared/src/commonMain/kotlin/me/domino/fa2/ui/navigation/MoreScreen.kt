...
private fun MoreContent(
    ...
    LazyColumn(
        ...
        item {
            SettingsGroup(
                ...
                SettingsListItem(
                    ...
                    title = "浏览记录",
                    subtitle = if (state.submissionHistoryCount > 0) {
                ...
                SettingsListItem(
                    ...
                    title = "搜索记录",
                    subtitle = if (state.searchHistoryCount > 0) {
        ...
        state.errorMessage?.takeIf { value -> value.isNotBlank() }?.let { message ->
            item {
                Text(
                    text = message,
