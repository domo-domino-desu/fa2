...
internal val orderByOptions = listOf(
    FilterOption("relevancy", "Relevancy"),
    FilterOption("date", "Date"),
    FilterOption("popularity", "Popularity"),
)

internal val orderDirectionOptions = listOf(
    FilterOption("desc", "Descending"),
    FilterOption("asc", "Ascending"),
)

internal val rangeOptions = listOf(
