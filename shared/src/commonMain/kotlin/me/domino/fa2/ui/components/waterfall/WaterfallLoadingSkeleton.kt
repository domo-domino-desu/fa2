package me.domino.fa2.ui.components.waterfall
...
fun WaterfallLoadingSkeleton(
  ...
  val skeletonHeights =
      remember(itemCount) { List(itemCount) { index -> index to Random.nextInt(164, 308).dp } }
  LazyVerticalStaggeredGrid(
    ...
    if (headerContent != null) {
      item(key = "waterfall-loading-skeleton-header", span = StaggeredGridItemSpan.FullLine) {
        headerContent()
      }
    }
