...
class SubmissionSeriesServiceTest {
  private val resolver =
      SubmissionSeriesService(repository = FakeSubmissionSeriesSubmissionSource())
  ...
  fun resolvesSeriesFromExplicitFirstAndUsesNumberedOrder() = runTest {
    val repository =
        FakeSubmissionSeriesSubmissionSource(
            details =
                listOf(
                    fakeSubmission(
                        sid = 401,
    ...
    val localResolver = SubmissionSeriesService(repository)
    val candidate =
...
private class FakeSubmissionSeriesSubmissionSource(
