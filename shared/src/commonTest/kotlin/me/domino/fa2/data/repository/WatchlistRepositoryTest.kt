...
class WatchlistRepositoryTest {
    ...
    fun loadUsesCacheAndRefreshForcesRefetch() = runTest {
        ...
        val first = repository.loadWatchlistPage(
            username = "terriniss",
        ...
        val second = repository.loadWatchlistPage(
            username = "terriniss",
            category = WatchlistCategory.WatchedBy,
            nextPageUrl = null,
        )
        ...
        val refreshed = repository.refreshWatchlistFirstPage(
            username = "terriniss",
            category = WatchlistCategory.WatchedBy,
        )
    ...
    fun categoriesUseIndependentCaches() = runTest {
        ...
        val watchedBy = repository.loadWatchlistPage(
            username = "terriniss",
            category = WatchlistCategory.WatchedBy,
            nextPageUrl = null,
        )
        val watching = repository.loadWatchlistPage(
            username = "terriniss",
        ...
        val watchedByCached = repository.loadWatchlistPage(
            username = "terriniss",
            category = WatchlistCategory.WatchedBy,
            nextPageUrl = null,
        )
