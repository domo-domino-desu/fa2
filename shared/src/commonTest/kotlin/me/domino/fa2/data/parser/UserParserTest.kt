...
class UserParserTest {
    ...
    fun parsesUserHeaderFromHomePage() {
        ...
        assertTrue(header.watchActionUrl.contains("/watch/") || header.watchActionUrl.contains("/unwatch/"))
